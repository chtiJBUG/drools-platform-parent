...
@Component
public class BeforeNodeInstanceTriggeredEventStrategy extends AbstractMemoryEventHandlerStrategy {
    private static final Logger LOG = Logger.getLogger(BeforeNodeInstanceTriggeredEventStrategy.class);
