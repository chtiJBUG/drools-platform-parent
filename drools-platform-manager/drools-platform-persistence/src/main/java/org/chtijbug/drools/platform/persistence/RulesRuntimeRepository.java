...
public interface RulesRuntimeRepository extends JpaRepository<RuleRuntime, Long> {
    ...
    RuleRuntime findByRuleBaseIDAndSessionIDAndRuleFlowNameAndRuleName(@Param("ruleBaseID") Integer ruleBaseID, @Param("sessionID") Integer sessionId, @Param("ruleFlowGroup") String ruleFlowGroup, @Param("ruleName") String ruleName);
}
